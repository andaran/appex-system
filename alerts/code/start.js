const start = [
  ...
  {
    type: 'POP_UP',
    text: 'Эта кнопка клонирует приложение.',
    target: '.project-card__clone',
    code: false,
  },
  {
    type: 'ALERT',
    title: 'Клоны',
    text: `
    Клонирование приложений - это усовершенствование стандартного подхода к скачиванию
    их. Клонов можно создать бесконечно много. У клонов можно менять иконку и название, но 
    код будет наследоваться от изначального приложения.
    `,
    code: false,
  },
  {
